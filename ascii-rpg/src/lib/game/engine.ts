...
import { addMessage, handlePlayerDeath, isBlocked, detectAdjacentSecrets, tryDropLoot, tickEntityEffects, processAchievements, xpForLevel, xpReward, applyXpMultiplier, effectiveSightRadius, checkLevelUp, relocateNpc, tickNpcMoods, learnRitual, revealOverworldArea } from './engine-utils';
import { buildDialogueContext, checkCondition, rollSocialCheck, SOCIAL_SKILL_DISPLAY, handleDialogueChoice, canDetectLies, MOOD_DISPLAY, npcMoodColor, garbleText, closeDialogue, SOCIAL_CLASS_BONUS } from './dialogue-handler';
