...
import { SPELL_CATALOG, getSpellDef, executeSpell, effectiveManaCost, FORBIDDEN_SCHOOLS, createTerrainEffects, getLeyLineEffectModifier, getEnvironmentalModifier } from './spells';
...
import { RITUAL_CATALOG, getRitualDef, hasReagents, getMissingReagents, consumeReagents } from './rituals';
import type { RitualDef } from './rituals';
import { addMessage, handlePlayerDeath, isBlocked, detectAdjacentSecrets, processAchievements, xpForLevel, effectiveSightRadius, checkLevelUp, learnRitual, revealOverworldArea } from './engine-utils';
...
import { dimColor, renderLocationColored } from './renderer';
...
// tickTerrainEffects is now in ./engine-utils.ts
...
// checkRitualInterrupt is now in ./engine-utils.ts
...
export { xpForLevel, xpReward, effectiveSightRadius, addMessage, isBlocked, handlePlayerDeath, checkLevelUp, applyXpMultiplier, processAchievements, detectAdjacentSecrets, tryDropLoot, tickEntityEffects, relocateNpc, tickNpcMoods, learnRitual } from './engine-utils';
